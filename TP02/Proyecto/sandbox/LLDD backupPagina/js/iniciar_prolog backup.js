...
async function iniciarProlog() {
    ...
    console.log("Esperando a que los módulos se expongan...");
    
    // Verificamos si ya existe antes de usarla
    if (typeof window.mostrarMensaje !== 'undefined') {
        window.mostrarMensaje("Iniciando partida...");
        window.arrancarPartidaReal();
    } else {
        console.error("Error: mostrarMensaje no se definió a tiempo.");
    }
