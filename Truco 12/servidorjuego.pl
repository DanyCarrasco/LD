...
:- dynamic motor_juego_ws:jugadores_iniciales/1.
:- dynamic motor_juego_ws:jugador_actual/1.
:- dynamic motor_juego_ws:jugador_habilitado_canto/1.
:- dynamic motor_juego_ws:envido_disponible/1.
